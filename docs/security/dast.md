...
- [x] Latest reviewed artifact: GitHub run `26656528773` for commit `fc8e85b` generated `2026-05-29T19:03:59.037Z`; coverage was complete, API alerts were `0`, web alerts were `1` informational `Modern Web Application`, and the evidence passed `pnpm dast:check-zap-evidence` with Next.js script nonces.
